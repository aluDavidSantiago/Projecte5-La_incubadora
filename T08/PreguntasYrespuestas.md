# Verificación del funcionamiento de un programa antimalware
...
- Análisis rápido, completo y personalizado  
- Historial de protección con amenazas detectadas  
...
Windows 11 ofrece:
- **Acceso controlado a carpetas**, que evita modificaciones no autorizadas  
- Posibilidad de permitir aplicaciones concretas  
- Opciones de recuperación mediante copias de seguridad como **OneDrive**  
...
Los archivos de la carpeta Documentos son cifrados y se crea un archivo **READ_ME.txt** que contiene la clave de recuperación.
...
Utilizaba la vulnerabilidad **CVE-2017-0144**, relacionada con el exploit **EternalBlue**, considerada de gravedad crítica.
...
- Limitar servicios innecesarios  
...
- No pagar el rescate  
- Restaurar copias de seguridad si existen  
- Analizar el sistema  
- Aplicar las actualizaciones de seguridad necesarias  
